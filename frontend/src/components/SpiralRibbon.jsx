...
function SpiralRibbon() {
    ...
    useEffect(() => {
        ...
        let animationId;
        let offset = pathRef.current?.getTotalLength() || 3000;
        const speed = 8;

        const animate = () => {
            offset -= speed;
            if (offset < -1000) {
                offset = pathRef.current?.getTotalLength() || 3000;
            }
            ...
            >
                <defs>
                    <linearGradient id="toxicGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                        ...
                        <stop offset="50%" stopColor="#9ACD32" stopOpacity="0.6" />
                ...
                <path
                    ...
                    style={{
                        ...
                        transition: isLoaded ? 'none' : 'stroke-dashoffset 0.5s ease-out'
                    }}
                />
            </svg>
        </div>
